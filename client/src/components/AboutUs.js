    ...
    return (
        <Stack gap={8} >
            ...
            <div > 
                ...
                <h3 className='about'> The purpose of this web app is to enable individuals to meet with random individuals in a randomized groupchat consisting of 4 individuals, where they will be able to play multiplayer
